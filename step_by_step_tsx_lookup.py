#!/usr/bin/env python3
"""
Step-by-Step TSX/TSX-V Ticker Lookup

Lookup tickers for Canadian companies systematically
"""
...
def extract_tsx_companies():
    ...
    try:
        with open('/dropbox/01. Asset Ownership/极端赛车开奖结果查询02. general_information/general_information_20260219.csv', 'r') as f:
...
def lookup_tsx_ticker_step_by_step(companies, batch_size=100):
    ...
    known_mappings = {
        ...
        "000026380": {"ticker": "CFM", "exchange": "TSXV", "source": "TMX"},
        "000031474": {"ticker": "AUE", "exchange": "TSX", "source": "TMX"},
        "000004056": {"ticker": "CMB", "exchange": "TSXV", "source": "TMX"},
        "000033595": {"ticker": "IVN", "exchange": "TSX", "source": "TMX"},
        "000003467": {"ticker": "AUN", "exchange": "TSXV", "source": "TMX"},
        "000012509": {"ticker": "TCM", "exchange": "TSX", "source": "TMX"},
        "000025546": {"ticker": "AR", "exchange": "TSX", "source": "TMX"},
